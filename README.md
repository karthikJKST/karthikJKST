<div align="center" style="position: relative; overflow: hidden; padding: 48px 0 36px;">

<img src="assets/request-flow.svg" width="100%" style="position: absolute; top: 0; left: 0; z-index: 0; pointer-events: none; opacity: 0.5;"/>

<div style="position: relative; z-index: 1;">

<br/>

<h1 style="font-size: 3rem; font-weight: 700; color: #f0f6fc; margin: 0; letter-spacing: -1.5px; line-height: 1.1;">Jana Karthik<br/>Siva Teja</h1>

<br/>

<p style="font-size: 1rem; color: #58a6ff; margin: 0; letter-spacing: 1px; text-transform: uppercase; font-weight: 500;">Java Backend Engineer</p>

<br/>

<p style="font-size: 1.1rem; color: #8b949e; max-width: 540px; margin: 0 auto; line-height: 1.7;">
...
<p align="center" style="color: #3fb950; font-size: 0.85rem; margin: 0 0 20px;">● Live in Production</p>

<div align="center" style="max-width: 760px; margin: 0 auto;">
<div style="background: #1c2333; border-radius: 10px; overflow: hidden; border: 1px solid #30363d; display: inline-block;">
  <div style="background: #21262d; padding: 10px 18px; text-align: left; display: flex; gap: 8px; align-items: center;">
    <span style="width: 12px; height: 12px; border-radius: 50%; background: #ff5f56; display: inline-block;"></span>
    <span style="width: 12px; height: 12px; border-radius: 50%; background: #ffbd2e; display: inline-block;"></span>
    <span style="width: 12px; height: 12px; border-radius: 50%; background: #27c93f; display: inline-block;"></span>
    <span style="color: #8b949e; font-size: 0.75rem; margin-left: 10px;">weekdays.app</span>
  </div>
  <a href="assets/weekdays-dashboard.png"><img src="assets/weekdays-dashboard.svg" width="100%" alt="WeekDays Dashboard" style="display: block; max-width: 760px;"/></a>
</div>
</div>

<br/>

<p align="center" style="color: #8b949e; max-width: 560px; margin: 0 auto 16px;">
  ...
  <tr>
    <td width="50%" valign="top" style="padding: 0 12px 0 0;">
      <div style="background: #1c2333; border-radius: 10px; overflow: hidden; border: 1px solid #30363d;">
        ...
        <a href="assets/stockflow-market.png"><img src="assets/stockflow-market.svg" width="100%" alt="StockFlow" style="display: block;"/></a>
      </div>
    ...
    <td width="50%" valign="top" style="padding: 0 6px 0 12px;">
      <div style="background: #1c2333; border-radius: 10px; overflow: hidden; border: 1px solid #30363d;">
        ...
        <a href="assets/hirepilot-interview.png"><img src="assets/hirepilot-interview.svg" width="100%" alt="HirePilot" style="display: block;"/></a>
      </div>
      <h3 style="margin: 12px 0 2px; font-size: 1.05rem;">HirePilot</h3>
      <p style="color: #3fb950; font-size: 0.75rem; margin: 0 0 6px;">● Live</p>
      <p style="color: #8b949e; font-size: 0.85rem; margin: 0 0 10px;">AI interview preparation with Gemini question generation and scoring.</p>
      <p style="margin: 0 0 10px;">
...
<p style="color: #8b949e; margin: 0 0 16px;">Interested in collaborating? I'm open to software engineering roles.</p>
...
<p style="color: #30363d; font-size: 0.75rem;">© 2026</p>
